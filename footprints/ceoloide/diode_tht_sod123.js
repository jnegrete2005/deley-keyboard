...
module.exports = {
    ...
    (footprint "ceoloide:diode_tht_sod123"
		...
		const via = `
        (via (at ${p.eaxy(-3, 0)}) (size 0.6) (drill 0.3) (layers "F.Cu" "B.Cu") (net ${p.to.index}))
        (segment (start ${p.eaxy(-1.65, 0)}) (end ${p.eaxy(-3, 0)}) (width 0.20) (layer "${p.side}.Cu") (net ${p.to.index}))
        `;
